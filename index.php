...
<div class="header" id="header-id">
  ...
  <div id="content">
     <div class="product" id="product">
        ...
        <h1 id="title">اولین مجموعه آموزشی طراحی وب با تمامی زبان های مورد نیاز</h1>
        <div style="padding: 15px; "> <hr>
          <h3 id="body">آیا برای شما هم اتفاق افتاده که بخواهید طراحی وب را شروع کنید ولی زبان های زیادی را باید یاد بگیرید و نمی دانید کدام است و یا کدام خوب است؟ آیا برای شما اتفاق افتاده که برای یادگیری طراحی وب هزینه های زیادی برای کلاس ها و یا برای هر زبان هزینه های زیادی برای خرید فیلم های آموزشی صرف کنید؟</h3>
        </div>
